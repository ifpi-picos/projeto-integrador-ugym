...
export type StackActionHelpers<ParamList extends ParamListBase> = {
    ...
    popTo<RouteName extends keyof ParamList>(...args: {
        [Screen in keyof ParamList]: undefined extends ParamList[Screen] ? [screen: Screen] | [screen: Screen, params: ParamList[Screen]] | [screen: RouteName, params: ParamList[Screen], merge: boolean] : [screen: Screen, params: ParamList[Screen]] | [screen: RouteName, params: ParamList[Screen], merge: boolean];
    }[RouteName]): void;
};
