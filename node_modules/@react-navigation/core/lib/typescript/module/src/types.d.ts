...
export type DefaultNavigatorOptions<ParamList extends ParamListBase, NavigatorID extends string | undefined, State extends NavigationState, ScreenOptions extends {}, EventMap extends EventMapBase, Navigation> = DefaultRouterOptions<Keyof<ParamList>> & {
     ...
     */
    UNSTABLE_getStateForRouteNamesChange?: (state: NavigationState) => PartialState<NavigationState> | undefined;
...
export type PathConfig<ParamList extends {}> = {
     ...
     * A function returning a state, which may be set after modifying the routes name.
     */
    getStateForRouteNamesChange?: (state: NavigationState) => PartialState<NavigationState> | undefined;
};
