...
type StaticRouteConfig<ParamList extends ParamListBase, RouteName extends keyof ParamList, State extends NavigationState, ScreenOptions extends {}, EventMap extends EventMapBase, Navigation> = RouteConfigProps<ParamList, string, State, ScreenOptions, EventMap, Navigation> & RouteConfigComponent<ParamList, RouteName>;
